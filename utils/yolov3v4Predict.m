function outPutFeatures = yolov3v4Predict(cfg_file,weight_file,img,width,height)
...
outPutFeatures(:,:,[1,3]) = outPutFeatures(:,:,[1,3])*width;% x_center,width
outPutFeatures(:,:,[2,4]) = outPutFeatures(:,:,[2,4])*height;% y_center,height
